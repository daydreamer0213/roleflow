...
function messageDiscoveryReasonText(code) {
  return {
    ...
    BOSS_MESSAGE_SALARY_MISMATCH: "本地岗位薪资信息与会话不一致，请先人工核对。",
    BOSS_MESSAGE_CITY_MISMATCH: "本地岗位城市信息与会话不一致，请先人工核对。",
    BOSS_MESSAGE_COMPANY_MISMATCH: "本地岗位公司信息与会话不一致，请先人工核对。",
    BOSS_MESSAGE_THREAD_MISMATCH: "本地岗位会话标识不一致，请先人工核对。",
