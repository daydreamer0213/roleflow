...
class OpenAICompatibleAdapter {
  ...
  async matchJob(input) {
    const sparsePrompt = [
      ...
      "First remove industryContext and named-system terms before judging roleAlignment. If the remaining primary work is software maintenance, extension, integration, or delivery and the candidate proves concrete back-end, API, integration, or software-system delivery, you must use mostly_aligned; keep missing named-system lifecycle, business rules, or domain experience as requirement gaps rather than role-family gaps.",
