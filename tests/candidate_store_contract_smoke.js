...
const FACADE_EXPORTS = [
  ...
  "acquireSiteScanLease", "activateResumeOptimization", "addFollowUpNote", "applyJobQualityGovernance", "attachResumeDocumentFile", "attachWorkflowCommunication", "attachWorkflowScan", "attachWorkflowScanRun", "backfillHistoricalCommunicationOutcomes", "beginScanRun", "bindBatchToPlan", "buildBatchSummary", "buildFeedbackSummary", "checkpointScanProgress", "checkpointScanTarget", "claimScanRun", "claimWorkflowJobTaskRow", "clearSiteRuntimeState", "closeMessageReplyDrafts", "compareProfileVersions", "completeMessageReplyDraft", "completeWorkflowJobTaskRow", "confirmMatchingCard", "countWorkflowJobTaskStatuses", "countWorkflowJobTasks", "createAndBindScanBatch", "createBatch", "createMatchingCardDraft", "createResumeOptimization", "createScanRun", "createWorkflowRun", "decisionBucket", "deleteCandidateFact", "ensureFunnelEntry", "failWorkflowJobTaskRow", "finishJobAnalysisAttemptRow", "finishScanRun", "freezeReadyFunnelCohort", "getActiveMatchingCard", "getActiveSearchPlan", "getActiveWorkflowRun", "getBatch", "getCandidateMatchingContext", "getCandidateProfile", "getFunnelCohort", "getFunnelEntry", "getFunnelPolicy", "getLatestBatchId", "getLatestJobRefreshAttempt", "getLatestMainScanBatchId", "getLatestProfileVersionId", "getLatestResumableBatch", "getLatestScanRun", "getMatchingCard", "getMessageReplyDraft", "getModelCache", "getOutcomeAnalyticsSnapshot", "getPlatformFilterCatalog", "getResumeDocument", "getResumeOptimization", "getRunningJobAnalysisAttemptRow", "getScanRun", "getSearchPlan", "getSearchPlanDependency", "getSitePacingState", "getSiteRuntimeState", "getSiteScanLease", "getWorkflowHealthSnapshot", "getWorkflowJobTaskRow", "getWorkflowObservationJob", "getWorkflowRun", "getWorkflowRunByCommunicationBatch", "heartbeatScanRun", "immediateTransaction", "incrementWorkflowRunActivity", "incrementWorkflowTimeoutCounters", "insertJobAnalysisAttemptRow", "insertWorkflowJobTaskRow", "interruptOrphanedScanRuns", "isActivityProbeDue", "isJobAwaitingAction", "isWorkflowJobTaskObservationReady", "jobAnalysisAttemptRow", "listCandidateAnswerMemories", "listCandidateFactRevisions", "listCandidateFacts", "listCandidateJobEvents", "listCandidateProfiles", "listCandidateResumeVersions", "listDecisionPool", "listDecisionQueue", "listFunnelCohorts", "listFunnelEntries", "listFunnelProgressEvents", "listJobAnalysisAttemptRows", "listJobRefreshAttempts", "listLatestScanTargetResults", "listMatchingCards", "listMatchingResumeVersions", "listOpenMessageReplyDrafts", "listProfileVersions", "listReportJobs", "listResumeOptimizations", "listResumeParseAttempts", "listReusableJobDetails", "listScanTargetResults", "listSearchPlans", "listSiteAccessEvents", "listWorkflowJobTaskRows", "listWorkflowRuns", "markApplication", "markCandidateJob", "markWorkflowJobTasksStopped", "mergeBossPacingStates", "openDb", "reactivateWorkflowDetailRequiredTaskRow", "reassessBatchObservations", "recordCandidateJobEvent", "recordJobRefreshAttempt", "recordMessageReplyDrafts", "recordRecommendationFeedback", "recordResumeParseAttempt", "recordScanRunProcessExit", "recordScanTargetResult", "recordSiteAccessEvent", "recordWorkflowPlatformAccess", "recordWorkflowScanWait", "releaseSiteScanLease", "renewSiteScanLease", "requestWorkflowRunConfigurationPause", "rescorePlanObservations", "reviseCandidateAnswerMemory", "saveCandidateFact", "saveCandidateResumeVersion", "saveConfirmedMatchingCardRevision", "saveFunnelPolicy", "saveMatchingCardDraftEdit", "saveMessageReplyDraftEdit", "saveModelCache", "savePlatformFilterCatalog", "saveProfileAnalysis", "saveResumeOptimizationDraft", "saveSearchPlan", "selectClaimableWorkflowJobTaskRow", "selectEarliestRetryAvailableAt", "selectExpiredLeaseWorkflowJobTaskRows", "selectReadyWorkflowJobEntries", "setSitePacingState", "setSiteRuntimeState", "settleIncompleteWorkflowJobTaskRows", "sourceContentHash", "summarizeScanTargets", "transitionWorkflowRun", "updateCandidateProfile", "upsertJob", "upsertKeywordSource", "withdrawCandidateAnswerMemory", "workflowJobTaskRow"
].sort();

assert.strictEqual(CANDIDATE_EXPORTS.length, 29);
assert.strictEqual(FACADE_EXPORTS.length, 164);
