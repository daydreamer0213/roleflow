...
assert.deepEqual(PAGE_SPECS.map((page) => page.id), ["today-ready", "workflow-scanning", "queue-primary", "jobs-latest", "communication-review", "messages-unresolved", "funnel-current", "resume-draft", "interview-active", "settings", "onboarding-existing", "match-card", "profile", "resumes", "diagnostics"]);
...
assert.deepEqual(Object.fromEntries(PAGE_SPECS.map((page) => [page.family, page.primaryPolicy])), {
  ...
  communication: "required", messages: "required", funnel: "none-expected", resumeOptimization: "none-expected", interview: "none-expected", settings: "none-expected", onboarding: "required", matchCard: "none-expected", profile: "none-expected", resumes: "none-expected", diagnostics: "none-expected"
...
assert.deepEqual(Object.fromEntries(PAGE_SPECS.map((page) => [page.family, page.interactionPolicy])), {
  ...
  communication: "safety-not-executed", messages: "safety-not-executed", funnel: "safety-not-executed", resumeOptimization: "safety-not-executed", interview: "safety-not-executed", settings: "safety-not-executed", onboarding: "safety-not-executed", matchCard: "safety-not-executed", profile: "safety-not-executed", resumes: "safety-not-executed", diagnostics: "read-only-none"
