...
try {
  ...
  assert.strictEqual(freshMigrations[freshMigrations.length - 1].name, "message_reply_learning_v1");
  ...
  assert.strictEqual(SCHEMA_VERSION, MESSAGE_REPLY_LEARNING_VERSION);
