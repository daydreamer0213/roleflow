...
try {
  ...
  assert.strictEqual(freshMigrations[freshMigrations.length - 1].name, "workspace_platform_preferences_v1");
  ...
  assert.strictEqual(SCHEMA_VERSION, WORKSPACE_PLATFORM_PREFERENCES_VERSION);
  assert.strictEqual(
