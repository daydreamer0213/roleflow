...
function pageAudit({ pageId = "", primarySelector = "", primaryPolicy = "", relevantControlSelector = "" } = {}) {
  ...
  return {
    ...
    communicationHierarchy: pageId === "communication-review" ? { primarySolid: Boolean(primaryStyle?.backgroundColor && primaryStyle.backgroundColor !== "rgba(0, 0, 0, 0)" && primaryStyle.backgroundColor !== "rgb(255, 255, 255)" && primaryStyle.color === "rgb(255, 255, 255)"), destructiveOutline: destructiveStyle?.backgroundColor === "rgb(255, 255, 255)" && destructiveStyle?.color === "rgb(178, 58, 50)" && destructiveStyle?.borderColor === "rgb(178, 58, 50)" } : null,
